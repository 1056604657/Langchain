...
class DataProcess(object):
    ...
    def customer_split_docs(self):
        data = []
        self.ParseBlock(max_seq=1024)
        self.ParseBlock(max_seq=512)
        self.ParseAllPage(max_seq=256)
        self.ParseAllPage(max_seq=512)
        self.ParseOnePageWithRule(max_seq=256)
        self.ParseOnePageWithRule(max_seq=512)
        ...
        data.extend(self.data)  # 这一块很逻辑绕，多思考
        if data != []:
            print("yes")
        else:
            print("NO")
